...
namespace FFXIVAPP.Plugin.Radar.Controls
{
    ...
    public partial class Radar
    {
        ...
        protected override void OnRender(DrawingContext drawingContext)
        {
            ...
            {
                var npcFilters = PluginViewModel.Instance.Filters.Where(filter => filter.Type != Entity.Type["PC"] && filter.Type != Entity.Type["Monster"])
                                                .ToList();
                if (npcFilters.Any())
                {
                ...
                var monsterFilters = PluginViewModel.Instance.Filters.Where(filter => filter.Type == Entity.Type["Monster"])
                                                    .ToList();
                ...
                var pcFilters = PluginViewModel.Instance.Filters.Where(filter => filter.Type == Entity.Type["PC"])
                                               .ToList();
                if (pcFilters.Any())
                {
